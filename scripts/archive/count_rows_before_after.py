...
df = pd.read_csv('data/sorted_selected_columns_wave3.csv')
...
with open('results/rows_count_before_after.md', 'w') as f:
...
print("Counts have been saved to 'results/rows_count_before_after.md'.")