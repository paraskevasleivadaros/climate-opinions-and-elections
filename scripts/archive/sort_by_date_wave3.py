...
df = pd.read_csv('data/selected_columns_wave3.csv')
...
df_sorted.to_csv('data/sorted_selected_columns_wave3.csv', index=False)

print("Data has been sorted by 'RecordedDate' and saved to 'data/sorted_selected_columns_wave3.csv'")