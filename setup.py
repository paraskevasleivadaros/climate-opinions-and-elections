...
setup(
    name="climate-opinions-shift-elections-policies",  # Name of your package
    ...
    url="https://github.com/paraskevasleivadaros/climate-opinions-shift-elections-policies",  # Link to your repository
